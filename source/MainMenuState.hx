...
class MainMenuState extends MusicBeatState
{
	...
	public static var megapackVer:String = "2.6.5";
	public static var megapackName:String = megapackVer + " - Beta Update";
	...
	override function create()
	{
		...
		bg = MenuMusic.bg;
		if (_variables.music != "neo"){bg.color = 0xFF6a00b6;}			
		bg.scrollFactor.x = 0;
		...
		var versionShit:FlxText = new FlxText(5, FlxG.height - 18, 0, megapackName, 12);
