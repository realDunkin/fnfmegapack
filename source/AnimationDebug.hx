...
class AnimationDebug extends MusicBeatState
{
	...
	override function create()
	{
		...
		check_isPlayer = new FlxUICheckBox(200, 10, null, null, "Is Player", 100);
		tab_group_character.name = "Character";

		var characters:Array<String> = CoolUtil.coolTextFile(Paths.txt('characterList'));

		var player1DropDown = new FlxUIDropDownMenuCustom(50, 10, FlxUIDropDownMenuCustom.makeStrIdLabelArray(characters, true), function(character:String)
			{
		...
		player1TextField = new FlxUIInputText(50, 15, 70, daAnim, 8);
	...
	//	tab_group_character.add(player1TextField);
	...
	function genBoyOffsets(pushList:Bool = true):Void
	{
		...
		{
			var text:FlxText = new FlxText(50, 20 + (18 * daLoop), 0, anim + ": " + offsets, 15);
	...
	override function update(elapsed:Float)
	{
		if (FlxG.keys.pressed.ENTER)
		{
			...
			updateTexts();
			genBoyOffsets(false);
			trace (daAnim + ' should equal ' + player1TextField.text);
		}
