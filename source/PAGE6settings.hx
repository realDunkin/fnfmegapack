...
class PAGE6settings extends MusicBeatSubstate
{
    ...
    var optionShit:Array<String> = ['page', 'save', 'config', 'keybinds', 'modifiers'];
    ...
    override function update(elapsed:Float)
        {
            ...
            switch (optionShit[curSelected])
            {
                ...
                case "keybinds":
                    ResultText.text = "";
                    ExplainText.text = "RESET KEYBINDS:\nWill reset your keybinds to default.";
                case "modifiers":
                    ResultText.text = "";
                    ExplainText.text = "CLEAR MODIFIERS:\nWill reset your modifier settings back to default.";
            }
    ...
    function clearStuff():Void
    {
        switch (optionShit[curSelected])
		{
            ...
            case 'keybinds':
                MenuMusic.ConfirmSound();
                MainVariables.ResetCustomBinds();
            case 'config':
                MenuMusic.ConfirmSound();
