...
class Controls extends FlxActionSet
{
	...
	public function setVirtualPad(virtualPad:FlxVirtualPad, ?DPad:FlxDPadMode, ?Action:FlxActionMode) {
		...
		switch (Action)
		{
			...
			case A_B_ONE:
				inline forEachBound(Control.ACCEPT, (action, state) -> addbutton(action, virtualPad.buttonA, state));
				inline forEachBound(Control.BACK, (action, state) -> addbutton(action, virtualPad.buttonB, state));
				inline forEachBound(Control.ONE, (action, state) -> addbutton(action, virtualPad.buttonOne, state));			
			case A_B_SHIFT:
				inline forEachBound(Control.ACCEPT, (action, state) -> addbutton(action, virtualPad.buttonA, state));
				inline forEachBound(Control.BACK, (action, state) -> addbutton(action, virtualPad.buttonB, state));			
				inline forEachBound(Control.SHIFT, (action, state) -> addbutton(action, virtualPad.buttonShift, state));
			case A_B_X_Y:
				inline forEachBound(Control.ACCEPT, (action, state) -> addbutton(action, virtualPad.buttonA, state));
				inline forEachBound(Control.BACK, (action, state) -> addbutton(action, virtualPad.buttonB, state));
			case NONE:
	...
	public function loadKeyBinds()
	{
		...
		removeKeyboard();
		MainVariables.LoadCustomBinds();
	
		inline bindKeys(Control.N0, [FlxKey.fromString(_keybind.n0Bind)]);
		inline bindKeys(Control.N1, [FlxKey.fromString(_keybind.n1Bind)]);
		inline bindKeys(Control.N2, [FlxKey.fromString(_keybind.n2Bind)]);
		inline bindKeys(Control.N3, [FlxKey.fromString(_keybind.n3Bind)]);
		inline bindKeys(Control.N4, [FlxKey.fromString(_keybind.n4Bind)]);
		inline bindKeys(Control.N5, [FlxKey.fromString(_keybind.n5Bind)]);
		inline bindKeys(Control.N6, [FlxKey.fromString(_keybind.n6Bind)]);
		inline bindKeys(Control.N7, [FlxKey.fromString(_keybind.n7Bind)]);
		inline bindKeys(Control.N8, [FlxKey.fromString(_keybind.n8Bind)]);

		inline bindKeys(Control.UP, [FlxKey.fromString(_keybind.upBind), FlxKey.UP]);
		inline bindKeys(Control.DOWN, [FlxKey.fromString(_keybind.downBind), FlxKey.DOWN]);
		inline bindKeys(Control.LEFT, [FlxKey.fromString(_keybind.leftBind), FlxKey.LEFT]);
		inline bindKeys(Control.RIGHT, [FlxKey.fromString(_keybind.rightBind), FlxKey.RIGHT]);
		inline bindKeys(Control.ACCEPT, [Z, SPACE, ENTER]);
		inline bindKeys(Control.SHIFT, [FlxKey.SHIFT]);
		inline bindKeys(Control.BACK, [BACKSPACE, ESCAPE]);
		inline bindKeys(Control.PAUSE, [P, ENTER, ESCAPE]);
		inline bindKeys(Control.RESET, [R]);
		inline bindKeys(Control.ONE, [FlxKey.ONE]);

		inline bindKeys(Control.L1, [FlxKey.fromString(_keybind.l1Bind)]);
		inline bindKeys(Control.U1, [FlxKey.fromString(_keybind.u1Bind)]);
		inline bindKeys(Control.R1, [FlxKey.fromString(_keybind.r1Bind)]);
		inline bindKeys(Control.L2, [FlxKey.fromString(_keybind.l2Bind)]);
		inline bindKeys(Control.D1, [FlxKey.fromString(_keybind.d1Bind)]);
		inline bindKeys(Control.R2, [FlxKey.fromString(_keybind.r2Bind)]);
