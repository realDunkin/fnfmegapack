...
class Substate_ChartType extends MusicBeatSubstate
{
    ...
    var sidehinttext:FlxText;
    var whichside:String = "Boyfriend Side";
    ...
    public function new()
    {
        ...
        sidetext = new FlxText(0, 0, 0, "Play as : " + whichside, 20);
		sidetext.setFormat(Paths.font("vcr.ttf"), 30, FlxColor.WHITE, RIGHT);
		sidetext.setBorderStyle(OUTLINE, 0xFF000000, 3, 1);
		sidetext.scrollFactor.set();
		sidetext.screenCenter(X);
        add(sidetext);

        sidehinttext = new FlxText(0, sidetext.y + 20, 0, "Press 1 to change side", 15);
		sidehinttext.setFormat(Paths.font("vcr.ttf"), 30, FlxColor.WHITE, RIGHT);
		sidehinttext.setBorderStyle(OUTLINE, 0xFF000000, 3, 1);
		sidehinttext.scrollFactor.set();
		sidehinttext.screenCenter(X);
        add(sidehinttext);
    ...
    override function update(elapsed:Float)
    {
        ...
        {
            whichside = "Dad Side";
            sidetext.text = "Play as : " + whichside;
        }
        else
        {
            whichside = "Boyfriend Side";
            sidetext.text = "Play as : " + whichside;
        }
        ...
        if (selectable && !selectedSomethin)
        {
            ...
            if (controls.RIGHT_P || controls.LEFT_P)
            {
                ...
                Main.switchside = !Main.switchside;
            }
